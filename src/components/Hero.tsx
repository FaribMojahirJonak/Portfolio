      ...
      <div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
        ...
        >
          <motion.button
            ...
            className="px-8 py-4 bg-gradient-to-r from-[#00d4ff] to-[#00a3cc] rounded-lg backdrop-blur-sm border border-primary/50 shadow-lg shadow-primary/20 hover:shadow-primary/40 transition-all duration-300"
          >
            View Portfolio
          </motion.button>
          <motion.button
            ...
            className="px-8 py-4 bg-white/5 rounded-lg backdrop-blur-sm border border-secondary/50 shadow-lg hover:bg-white/10 transition-all duration-300"
          >
            Get in Touch
          </motion.button>
        </motion.div>
